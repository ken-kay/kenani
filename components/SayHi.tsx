  ...
  return (
    <section id='say-hi'>           
        ...
        <div className='flex text-center items-center justify-center sm:py-20 my-10 py-16 md:flex-row md:space-x-4 md:text-left md:py-69'>
            ...
            <button className='py-5 px-10 rounded-md font-bold text-lg bg-sky hover:bg-slate-400'
                type='submit'>
                    Contact Form
                </button>
            </a>
    ...
    <div className='bg-gradient-to-r from-cyan-500 to-blue-500 py-5'>
         <h2 className='font-bold text-6xl mt-6 text-center'>My Links:</h2>
         <h3 className='text-2xl mx-auto mt-2 text-center'>Find me online:</h3>
            <h3><ul className='text-xl font-bold w-fit mx-auto px-5 py-5 mb-2'>
                <li className='outline outline-2  outline-offset-2 py-1 px-5 my-5 hover:bg-pinky'><a href='https://github.com/ken-kay'>GitHub</a></li>
                <li className='outline outline-2  outline-offset-2 py-1 px-5 my-5 hover:bg-pinky'><a href='https://www.linkedin.com/in/kenani-kenani/'>LinkedIn</a></li>
            ...
            <div>
                ...
                <h2 className='pt-2 flex flex-col space-y-2 w-fit mx-auto'>I will do my best to reply</h2>
            </div>
        </div>
        <div className='pt-10 flex flex-col space-y-2 w-fit mx-auto'>
            <a href='mailto:kenanikay@gmail.com'>
            <button className='py-5 px-10 rounded-md font-bold text-lg bg-sky dark:bg-pinky hover:bg-pinky dark:hover:bg-slate-400'
                type='submit'>
                    Say Hi!
                </button>
            </a>
